...
void rotateClocks(std::vector<uint32_t> &clocks, bool isId);
...
size_t search_seeds(std::vector<uint32_t> &clocks, uint32_t skipped, seeddata data, std::set<uint32_t> &seeds);
